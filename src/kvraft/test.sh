...
do
  ...
  #go test -run TestSnapshotRecoverManyClients3B >> out
  #go test -run TestSnapshotUnreliable3B >> out
  #go test -run TestSnapshotUnreliableRecover3B >> out
  #go test -run TestSnapshotUnreliableRecoverConcurrentPartition3B >> out
  #go test -run TestSnapshotUnreliableRecoverConcurrentPartitionLinearizable3B >> out
  sleep 1s
