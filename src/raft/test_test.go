...
func TestReElection2A(t *testing.T) {
	...
	//fmt.Println("after checkNoLeader, rf:", (leader1) % servers, "state:", cfg.rafts[(leader1) % servers].state, "term:", cfg.rafts[(leader1) % servers].currentTerm)
...
func TestBasicAgree2B(t *testing.T) {
	...
	iters := 3
	for index := 1; index < iters+1; index++ {  //日志索引从1到3
